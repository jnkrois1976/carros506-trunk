	...
	<section class="newListingForm">
		...
		<div class="mainContentPages">
			...
			<div class="horizontalBlock">
				<form action="/new_listing/create_full_post" method="post" enctype="multipart/form-data" class="newListing" id="newListingFull" novalidate="novalidate">
					<fieldset class="newListingSection">
						...
						<input type="hidden" name="totalImages" id="totalImagesHidden" value="20" />
						<input type="hidden" name="listingCat" id="picListingCap" value="A" />
						...
						<table cellpadding="0" cellspacing="0" border="0">
							...
							<?php if($contact_query['contact_categoria'] == "AG"): ?>
								<tr>
									<td><label for="sellerName">Contacto:</label></td>
									<td>
									...
									<tr>
										...
										<td>
											...
											<?php elseif($contact_query['dealer_name'] == ""): ?>
												<input type="text" name="dealerName" id="dealerName" required="true" value="" data-error="Por favor digite el nombre de la Agencia" onclick="this.select();" autocomplete="off" data-validationtype="text"  placeholder="Nombre de la Agencia..." />
											<?php endif; ?>
										</td>
									</tr>
									<tr>
								...
								<?php elseif($contact_query['profile_complete'] == 0): ?>
									<tr>
										<td><label class="fieldRequired" for="dealerName">Agencia</label></td>
										<td>
											<input
												type="text"
												name="dealerName"
							...
							<tr style="display: none;">
								<td><label for="seller_cat">Categor&iacute;a:</label></td>
								<td>
					...
					<fieldset class="newListingSection">
						...
						<table cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<td><label class="fieldRequired" for="carCC">CC</label></td>
								<td>
									<input
										type="text"
										name="carCC"
							...
							<tr>
								<td><label class="fieldRequired" for="carColor">Color</label></td>
								<td>
									<input
										type="text"
										name="carColor"
							...
							<tr>
								<td><label class="fieldRequired" for="carDoors">Puertas</label></td>
								<td>
									<input
										type="text"
										name="carDoors"
							...
							<tr>
								<td><label class="fieldRequired" for="carBody">Carrocer&iacute;a:</label></td>
								<td>
									<select name="carBody" id="carBody" data-error="Por favor seleccione un tipo de carrocer&iacute;a" required="true">
										<option value="">Seleccione una opci&oacute;n</option>
							...
							<tr>
								<td><label class="fieldRequired" for="carCondition">Condici&oacute;n:</label></td>
								<td>
									<select name="carCondition" id="carCondition" data-error="Por favor seleccione el estado del carro" required="true">
										<option value="">Seleccione una opci&oacute;n</option>
							...
							<tr>
								<td><label class="fieldRequired" for="carFuel">Combustible</label></td>
								<td>
									<select name="carFuel" id="carFuel" data-error="Por favor seleccione el tipo de combustible" required="true">
										<option value="">Seleccione una opci&oacute;n</option>
										<option value="Gasolina">Gasolina</option>
										<option value="Diesel">Diesel</option>
										<option value="El&eacute;ctrico">El&eacute;ctrico</option>
							...
							<tr>
								<td><label class="fieldRequired" for="carDrive">Tracci&oacute;n:</label></td>
								<td>
									<select name="carDrive" id="carDrive" data-error="Por favor seleccione el tipo de tracci&oacute;n" required="true">
										<option value="">Seleccione una opci&oacute;n</option>
							...
							<tr>
								<td><label class="fieldRequired" for="carCilinders">Cilindros</label></td>
								<td>
									<select name="carCilinders" id="carCilinders" data-error="Por favor seleccione los cilindros del motor" required="true">
										<option value="">Seleccione una opci&oacute;n</option>
					...
					<fieldset class="newListingSection">
						<legend><h5>Otros detalles y fotos</h5></legend>
						<table cellpadding="0" cellspacing="0" border="0">
							<tbody>
								<tr>
							...
							<tbody id="selectImage" style="display: none;">
								<tr>
									<td>
										<span>Puede agregar hasta 20 fotos a su anuncio.<label class="fieldRequired"></label></span><br /><br />
										...
										<div id="selectImages">
														...
														<table cellpadding="0" cellspacing="0" border="0" width="100%">
															<tr>
																<td width="90%" valign="center" align="center">
																	<h5 class="attention">
																		Por favor seleccione un m&aacute;ximo de 20 imagenes !
																	</h5>
																</td>
											...
											<div id="byteCounter">
												<span>El l&iacute;mite es de 20 fotos o 20.000KB (20MB)</span>
												...
												<span id="totalLimit" class="xlarge attention">20.000KB</span>
												...
												<span>
													<small>Si llega al l&iacute;mite y necesita agregar m&aacute;s fotos, lo puede hacer en la seccion de "mis anuncios" de su perfil.</small>
												</span>
							...
							<tbody id="selectImageFallback" style="display: none;">
								<tr>
									<td>
										<label class="fieldRequired" for="userfile">Puede agregar hasta 20 fotos a su anuncio</label>
										<!--<span>Total: <span id="livePicCount">0</span> de 20 (m&aacute;ximo)</span>-->
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr style="display: none;">
									<td>
										<div class="linkWithIcon">
											<span id="reachedMax"><strong>20 fotos m&aacute;ximo </strong><img src="/images/warning_red.png" /></span>
							...
							<tbody>
								<tr>
									<td>
										<div style="font-size:70%; padding-top:0;">
								...
								<tr>
									<td>
										...
										<input type="submit" class="secondaryButton" name="create_full" id="create" value="Publicar" />
										<div id="postNewAd">
