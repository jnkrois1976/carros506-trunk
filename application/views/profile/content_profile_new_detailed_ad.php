	...
	<section class="newListingForm">
		...
		<div class="mainContentPages">
			...
			<div class="horizontalBlock">
				<form action="/new_listing/create_detailed_post" method="post" enctype="multipart/form-data" class="newListing" id="newListingDetailed" novalidate="novalidate">
					<fieldset class="newListingSection">
						...
						<input type="hidden" name="totalImages" id="totalImagesHidden" value="10" />
						<input type="hidden" name="listingCat" id="picListingCap" value="B" />
					...
					<fieldset class="newListingSection">
						...
						<table cellpadding="0" cellspacing="0" border="0">
							...
							<tbody id="selectImage" style="display: none;">
								<tr>
									<td>
										<span>Puede agregar hasta 10 fotos a su anuncio.<label class="fieldRequired"></label></span><br /><br />
										...
										<div id="selectImages">
														...
														<table cellpadding="0" cellspacing="0" border="0" width="100%">
															<tr>
																<td width="90%" valign="center" align="center">
																	<h5 class="attention">
																		Por favor seleccione un m&aacute;ximo de 10 imagenes !
																	</h5>
																</td>
											...
											<div id="byteCounter">
												<span>El l&iacute;mite es de 10 fotos o 10.000KB (10MB)</span>
												...
												<span id="totalLimit" class="xlarge attention">10.000KB</span>
							...
							<tbody id="selectImageFallback" style="display: none;">
								<tr>
									<td>
										<label class="fieldRequired" for="userfile">Puede agregar hasta 10 fotos a su anuncio</label><br /><br />
										<!--<span>Total: <span id="livePicCount">0</span> de 10 (m&aacute;ximo)</span>-->
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr style="display: none;">
									<td>
										<div class="linkWithIcon">
											<span id="reachedMax"><strong>10 fotos m&aacute;ximo </strong><img src="/images/warning_red.png" /></span>
							...
							<tbody>
								...
								<tr>
									<td>
										...
										<input type="submit" class="secondaryButton" name="create_detailed" id="create" value="Publicar" />
										<div id="postNewAd">
