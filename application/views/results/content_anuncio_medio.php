					...
					<div class="commentsWapper">
						...
						<?php if($is_logged_in == true): ?>
							...
							<div id="addCommentSuccess" style="display:none; text-align:center;">
								...
								<h2 style="border:none;">Ya agregue el comentario, Gracias <?php echo $this->session->userdata('username'); ?>!</h2>
							</div>
							<div id="addCommentFailed" style="display:none; text-align:center;">
								<img src="/images/warning_large.png" /><br />
								<h5 style="border:none;">Se me fue por mal camino, y no pude agregar su comentario!</h5><br />
								Por favor intente de nuevo, apenas yo deje de toser!.
							</div>
						<?php endif; ?>
	...
	<?php if($is_logged_in == TRUE && $posting == TRUE): ?>
		<div id="dialogQuickMessage" title="Mensaje r&aacute;pido al vendedor" style="display: none;">
			...
			<div id="quickMessageSuccess" style="display:none; text-align:center;">
				<img src="/images/checkmark_large.png" /><br />
				<h2 style="border:none;">Ya envi&eacute; su mensaje. Gracias <?php echo $this->session->userdata('username'); ?>!</h2>
			</div>
			<div id="quickMessageFailed" style="display:none; text-align:center;">
				<img src="/images/warning_large.png" /><br />
				<h5 style="border:none;">Me di&oacute; un calambre, y no pude enviar su mensaje!</h5><br />
				Por favor intente de nuevo dentro de un ratito.
			</div>
		</div>
