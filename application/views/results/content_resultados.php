		...
		<div class="mainContentPages">
			<div class="horizontalBlock">
					...
					<div class="searchWidget">
						...
						<form method="post" action="/resultados/anuncios" class="quickSearch" id="quickSearch">
								...
								<div class="makesElemWrap">
									<input type="text" value="<?php
											if($this->input->post('make')){
												...
												echo $_COOKIE['valuemake'];
											}
										?>"
										placeholder="Escoja un fabricante..."
										name="make"
										id="make"
										onclick="this.select();"
										autocomplete="off"
										data-error="Seleccione una marca"
									/>
									<div id="makersList">
							...
							<div class="inputWrapper">
								...
								<div class="modelElemWrap">
									<div class="elemWrap">
										<input type="text" value="<?php
											...
											autocomplete="off"
											onclick="this.select();"
											data-error="Seleccione un modelo"
										/>
									</div>
									<div id="modelsList">
								...
								<select id="carModels" name="carModels" disabled="disabled">
									<?php foreach($allmodels as $allmodels_row): ?>
									<option value="<?php echo $allmodels_row->ad_modelo; ?>"><?php echo $allmodels_row->ad_modelo; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
				...
				<div class="rightWrapper">
					<h1 id="resultCounter">Esto es lo que encontr&eacute; <!--&nbsp;<img src="/images/load_bar.png" id="loaderBar" alt="Actualizando" />--></h1>
					...
					<hr />
						<?php if($requestedposts): ?>
							<?php foreach($requestedposts as $post_row): ?>
								<?php
									$today = date('Y-m-d');
										...
										<table cellpadding="0" cellspacing="0" border="0" class="postedAd" width="100%">
											...
											<tbody>
												<tr>
													...
													<td valign="top" align="right" class="hidden-phone">
												...
												<tr>
													<td style="position:relative;">
														...
														<?php if($images): ?>
															...
															<a class="viewAdLink" href="/resultados/anuncio/<?php echo $post_row->ad_idprefix.$post_row->ad_id; ?>">Ver detalles</a>
														<?php elseif(!$images): ?>
															<img src="/cars/large_thumb/no_image.jpg" class="postThumb"/>
														<?php endif; ?>
													</td>
													<td style="vertical-align:top;" class="hidden-phone">
												...
												<tr>
													<td style="position: relative;">
														...
														<?php if($images): ?>
															...
															<a class="viewAdLink" href="/resultados/anuncio_medio/<?php echo $post_row->ad_idprefix.$post_row->ad_id; ?>">Ver detalles</a>
														<?php elseif(!$images): ?>
															<img src="/cars/large_thumb/no_image.jpg" class="postThumb"/>
														<?php endif; ?>
													</td>
												...
												<tr>
													<td style="position: relative;">
														...
														<?php if($images): ?>
															...
															<a class="viewAdLink" href="/resultados/anuncio_basico/<?php echo $post_row->ad_idprefix.$post_row->ad_id; ?>">Ver detalles</a>
														<?php elseif(!$images): ?>
															<img src="/cars/large_thumb/no_image.jpg" class="postThumb"/>
														<?php endif; ?>
													</td>
													...
													<td style="vertical-align:top;" class="hidden-phone">&nbsp;</td>
												</tr>
											</tbody>
										</table>
									</div>
								<?php endif; ?>
							<?php endforeach; ?>
						<?php elseif(!$requestedposts): ?>
							<div class="serverError">
								<table cellpadding="0" cellspacing="0" border="0" width="100%">
									<tr>
										<td width="90%" valign="center" align="center">
											<h5>No hay carros disponibles bajo ese criterio de busqueda.<br />Por favor cambie las opciones para actualizar los resultados.</h5>
										</td>
